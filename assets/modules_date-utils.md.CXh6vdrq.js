...
`,W=JSON.parse('{"title":"Date Utils","description":"","frontmatter":{"title":"Date Utils","order":10},"headers":[],"relativePath":"modules/date-utils.md","filePath":"modules/date-utils.md"}'),w={name:"modules/date-utils.md"},A=Object.assign(w,{setup(x){const r=i();d(async()=>{r.value=(await m(async()=>{const{default:o}=await import("./chunks/GetTDate_1.DQfCAIim.js");return{default:o}},__vite__mapDeps([0,1,2,3,4]))).default});const l=R(!0),n=i();return d(async()=>{n.value=(await m(async()=>{const{default:o}=await import("./chunks/FormatDate_1.CvKZ-eXq.js");return{default:o}},__vite__mapDeps([5,1,2,3,4]))).default}),(o,t)=>{const s=b("ClientOnly");return T(),v("div",null,[t[2]||(t[2]=c('<h1 id="日期类相关业务工具函数" tabindex="-1">日期类相关业务工具函数 <a class="header-anchor" href="#日期类相关业务工具函数" aria-label="Permalink to &quot;日期类相关业务工具函数&quot;">​</a></h1><h2 id="formatdate-格式化日期" tabindex="-1">formatDate 格式化日期 <a class="header-anchor" href="#formatdate-格式化日期" aria-label="Permalink to &quot;formatDate 格式化日期&quot;">​</a></h2><p>将日期格式化为特定本地字符串</p><h3 id="典型场景" tabindex="-1">典型场景 <a class="header-anchor" href="#典型场景" aria-label="Permalink to &quot;典型场景&quot;">​</a></h3><ol><li>服务端下发的日期是 Date、时间戳时，需要正确显示到 UI 上</li></ol><h3 id="样例" tabindex="-1">样例 <a class="header-anchor" href="#样例" aria-label="Permalink to &quot;样例&quot;">​</a></h3>',6)),u(a(e(_),null,null,512),[[f,l.value]]),a(s,null,{default:h(()=>[a(e(p),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:t[0]||(t[0]=()=>{l.value=!1}),reactCode:e(k),reactComponent:n.value,reactCreateRoot:e(D),reactCreateElement:e(C.createElement)},null,8,["reactCode","reactComponent","reactCreateRoot","reactCreateElement"])]),_:1}),t[3]||(t[3]=c('<h2 id="gettdate-计算-t-n-日期" tabindex="-1">getTDate 计算 T + N 日期 <a class="header-anchor" href="#gettdate-计算-t-n-日期" aria-label="Permalink to &quot;getTDate 计算 T + N 日期&quot;">​</a></h2><p>通过传入时间 T，加上偏移天数 N（天）计算出 T + N 的时间</p><h3 id="典型场景-1" tabindex="-1">典型场景 <a class="header-anchor" href="#典型场景-1" aria-label="Permalink to &quot;典型场景&quot;">​</a></h3><ol><li>报表场景下，默认的日期一般是 T + N 格式，如 T + 1</li></ol><h3 id="样例-1" tabindex="-1">样例 <a class="header-anchor" href="#样例-1" aria-label="Permalink to &quot;样例&quot;">​</a></h3>',5)),u(a(e(_),null,null,512),[[f,l.value]]),a(s,null,{default:h(()=>[a(e(p),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:t[1]||(t[1]=()=>{l.value=!1}),reactCode:e(V),reactComponent:r.value,reactCreateRoot:e(D),reactCreateElement:e(C.createElement)},null,8,["reactCode","reactComponent","reactCreateRoot","reactCreateElement"])]),_:1})])}}});export{W as __pageData,A as default};
